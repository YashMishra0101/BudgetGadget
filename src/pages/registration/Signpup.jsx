...
const SignUp = () => {
  ...
  return (
    <div className="bg-gray-900 min-h-[48rem]">
      <div className="flex flex-col items-center justify-center px-6 py-5 md:py-8 mx-auto md:h-screen lg:py-0 relative top-10 ">
